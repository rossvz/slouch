defmodule SlouchWeb.Layouts do
  @moduledoc """
  ...
  def theme_toggle(assigns) do
    ...
    <div class="dropdown dropdown-end">
      <div tabindex="0" role="button" class="btn btn-ghost btn-sm btn-circle">
        <.icon name="hero-swatch-micro" class="size-5" />
      </div>
      <ul tabindex="0" class="dropdown-content menu bg-base-200 rounded-box w-48 p-2 shadow-lg">
        <li>
        ...
        <li>
          <button phx-click={JS.dispatch("phx:set-theme")} data-phx-theme="catppuccin-latte">
            <.icon name="hero-sun-micro" class="size-4" /> Catppuccin Latte
          </button>
        </li>
        <li>
          <button phx-click={JS.dispatch("phx:set-theme")} data-phx-theme="catppuccin-mocha">
